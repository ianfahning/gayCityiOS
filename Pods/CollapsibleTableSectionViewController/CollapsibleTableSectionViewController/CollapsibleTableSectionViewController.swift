...
@objc public protocol CollapsibleTableSectionDelegate {
    ...
    @objc optional func getHeaderIdentifer(identiferForHeader section: Int) -> String?
    ...
    @objc optional func changeView(_ identifier: String)
}
...
extension CollapsibleTableSectionViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let identifier = delegate?.getHeaderIdentifer?(identiferForHeader: section) ?? ""
        let header = tableView.dequeueReusableHeaderFooterView(withIdentifier: identifier) as? CollapsibleTableViewHeader ?? CollapsibleTableViewHeader(reuseIdentifier: identifier)
